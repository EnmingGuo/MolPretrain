...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default='/data1/gx/KPGT/datasets/qm9')
...
if __name__ == '__main__':
    ...
    reg_evaluator = Evaluator("Pubchem-10m", reg_metric, train_dataset.d_mds)
    clf_evaluator = Evaluator("Pubchem-10m", clf_metric, train_dataset.d_fps)
