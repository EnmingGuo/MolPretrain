...
class GTN(nn.Module):   
    def __init__(self, num_channels, w_in, w_out, num_layers, args=None, emb_dim=300):
        ...
        self.gcn = GCNConv(in_channels=self.w_in, out_channels=w_out, args=self.args)
        ...
        for _ in range(self.num_channels):
            self.batch_norms.append(nn.BatchNorm1d(w_in))
    ...
    def forward(self, data, num_nodes=None, eval=False):
        ...
        # SINGLE
        single_index = data['atom', 'SINGLE', 'atom']['edge_index']
        single_attr = data['atom', 'SINGLE', 'atom']['edge_attr']
        ...
        # DOUBLE
        double_index = data['atom', 'DOUBLE', 'atom']['edge_index']
        double_attr = data['atom', 'DOUBLE', 'atom']['edge_attr']
        ...
        # TRIPLE
        triple_index = data['atom', 'TRIPLE', 'atom']['edge_index']
        triple_attr = data['atom', 'TRIPLE', 'atom']['edge_attr']
        ...
        # AROMATIC
        aromatic_index = data['atom', 'AROMATIC', 'atom']['edge_index']
        aromatic_attr = data['atom', 'AROMATIC', 'atom']['edge_attr']
